...
In this set up, you (the application developer) own the space, your users upload data to your application server, and you upload it to web3.storage from there.
...
<Callout type="info">
  This does not provide visibility over which of your end users are uploading what; to track this, you'll need them to send you that information separately (e.g., once they've run upload and get back a content CID, you can have them send that CID to you for tracking).
</Callout>
