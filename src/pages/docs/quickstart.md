...
By default, `w3` will wrap uploaded files into a folder, so that filename is preserved. It can then be accessed directly by adding the name in the URL path:
