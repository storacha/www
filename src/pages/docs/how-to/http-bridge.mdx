...
You can store individual files as big as 5GB in spaces on web3.storage. To store larger files, see the [Sharded Uploads]
section below.
...
Next we'll use `carbites` to split this file. We are using the `50B` splitting into 50 byte
